...
Return a JSON object with exactly these fields:
{
  ...
  "vorsteuerSperre": true if the invoice shows VAT that is legally non-deductible per §12 UStG, else false,
  ...
  private parseResponse(content: string): ExtractedInvoiceData {
    ...
    try {
      ...
      const result: ExtractedInvoiceData = {
        ...
        vorsteuerSperre: isInvoice ? parsed.vorsteuerSperre === true : null,
