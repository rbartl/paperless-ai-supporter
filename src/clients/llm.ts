...
Return a JSON object with exactly these fields:
{
  ...
  "vorsteuerNichtAbzugsfaehig": true if the invoice shows VAT that is legally non-deductible per §12 UStG, else false,
...
export class LlmClient {
  ...
  getEmptyExtractionSeed(): ExtractedInvoiceData {
    return {
      ...
      vorsteuerNichtAbzugsfaehig: null,
      privatanteil: null,
      llmConfidence: null,
      summary: null,
    };
  ...
  private parseResponse(content: string): ExtractedInvoiceData {
    ...
    try {
      ...
      const result: ExtractedInvoiceData = {
        ...
        vorsteuerNichtAbzugsfaehig: isInvoice ? parsed.vorsteuerNichtAbzugsfaehig === true : null,
